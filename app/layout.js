...
const jsonLd = {
  ...
  description: 'Frontend Developer specialising in React, Next.js, Angular, FastAPI and MongoDB. 4+ years of experience building fast, scalable web applications.',
...
export const metadata = {
  ...
  description: 'Portfolio of Mudassir Khan — Frontend Developer from Hyderabad with 4+ years building fast, scalable web apps using React, Next.js, Angular, FastAPI and MongoDB.',
  keywords: [
    'Mudassir Khan', 'Frontend Developer', 'Frontend Developer', 'React Developer',
  ...
  twitter: {
    ...
    title: 'Mudassir Khan — Frontend Developer',
    description: 'Portfolio of Mudassir Khan — Frontend Developer with 4+ years of experience.',
    images: ['/og-image.png'],
  },
