  ...
  return (
    <section className='max-w-6xl p-2 mx-auto mt-10 '>
        <div className='flex justify-center w-full mb-8 gap-x-10'>
            ...
            >
              <Image src={linkedinIcon} alt='contact' width={50} height={50} />
            </a>
            <a href="https://github.com/Mudassirkhan2"
              target="_blank" rel="noopener noreferrer" className="cursor-pointer "
            >
                <Image src={GithubIcon} alt='contact' width={50} height={50} /> 
            </a>
            <a href="mailto:mudassir222001@gmail.com " target="_blank" rel="noopener noreferrer" className="cursor-pointer ">
              <Image src={gmailIcon} alt='contact' width={50} height={50} />
            </a>
            <a href="https://twitter.com/Mudassir_222" 
              target="_blank" rel="noopener noreferrer" className="cursor-pointer "
            >
              <Image src={twitterIcon} alt='contact' width={50} height={50} />
            </a>
        </div>
    </section>
  )
